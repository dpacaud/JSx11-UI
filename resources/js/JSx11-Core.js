...
/*
 ...
 loadJsFile(scriptsQueue.shift());
 }
 }


 function waitModulesLoading() {
 if(scriptLoading) {sleep(5); waitModulesLoading();}
 else debug("End waiting for modules loading !");
 }
